...
const themeRoot = path.resolve(__dirname, "../../extensions/shopoll-theme");
const core = require(path.join(themeRoot, "assets/shopoll-runtime.js"));

test("theme startup loader stays below Shopify's 10 KB asset threshold", () => {
  const loader = fs.readFileSync(path.join(themeRoot, "assets/shopoll.js"));
